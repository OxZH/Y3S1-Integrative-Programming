...
('fac-001', 'own-001', 'SmashPoint Badminton Centre', '/uploads/facility/fac-001.jpg', 'No. 12, Jalan Genting Klang',  'Setapak',    'Kuala Lumpur', 'Badminton Hall',  35.00, '08:00:00', '23:00:00', 3.2145000, 101.7268000, 'ACTIVE',  '2026-01-15 09:00:00'),
('fac-002', 'own-001', 'SmashPoint Court 2 (Indoor)',  '/uploads/facility/fac-002.jpg', 'No. 14, Jalan Genting Klang',  'Setapak',    'Kuala Lumpur', 'Basketball Court',50.00, '09:00:00', '22:00:00', 3.2147000, 101.7271000, 'ACTIVE',  '2026-01-16 09:30:00'),
('fac-003', 'own-002', 'Arena Klang Futsal',           '/uploads/facility/fac-003.jpg', 'Lot 88, Jalan Meru',           'Klang',      'Selangor',     'Futsal Court',    80.00, '10:00:00', '23:59:00', 3.0521000, 101.4381000, 'ACTIVE',  '2026-02-05 11:00:00'),
('fac-004', 'own-002', 'Arena Klang Annex (New)',      NULL,                           'Lot 90, Jalan Meru',           'Klang',      'Selangor',     'Badminton Hall',  40.00, '08:00:00', '22:00:00', 3.0525000, 101.4386000, 'PENDING', '2026-08-20 16:45:00');

-- ---------------------------------------------------------------------------
--  Events   (MODULE 1 - mine)
--  Today for this seed is 2026-08-25.
...
('evt-001', 'usr-001', 'fac-001', 'Friday Night Doubles',      'Badminton',  '2026-09-04', '20:00:00', '22:00:00',  4,  8, 'PUBLISHED',       'INTERMEDIATE', 'MODERATE', 'CASUAL',      'PUBLIC',       10.00, '2026-08-20 21:10:00'),
('evt-002', 'usr-002', 'fac-003', 'Sunday Futsal Kickabout',   'Futsal',     '2026-09-06', '16:00:00', '18:00:00',  8, 12, 'PUBLISHED',       'ANY',          'HIGH',     'CASUAL',      'FRIENDS_ONLY', 12.00, '2026-08-21 09:30:00'),
('evt-003', 'usr-003', 'fac-002', 'Midweek 3v3 Basketball',    'Basketball', '2026-09-09', '19:00:00', '21:00:00',  6, 10, 'PENDING_PAYMENT', 'BEGINNER',     'MODERATE', 'CASUAL',      'PUBLIC',        8.00, '2026-08-24 13:05:00'),
('evt-004', 'usr-001', 'fac-001', 'Weekend Singles Ladder',    'Badminton',  '2026-09-13', '09:00:00', '12:00:00',  4,  6, 'CANCELLED',       'ADVANCED',     'HIGH',     'COMPETITIVE', 'PUBLIC',       15.00, '2026-08-18 18:00:00'),
('evt-005', 'usr-002', 'fac-001', 'Pre-semester Warmup Games', 'Badminton',  '2026-08-15', '20:00:00', '22:00:00',  4,  8, 'COMPLETED',       'INTERMEDIATE', 'MODERATE', 'CASUAL',      'PUBLIC',       10.00, '2026-08-05 10:00:00');
...
('inv-001', 'evt-002', '7f3a9c1e4b8d2a6f0c5e9b3d7a1f4c8e2b6d0a9f3c7e1b5d8a2f6c0e4b9d3a7f', 'usr-002', '2026-08-21 09:35:00', '2026-09-06 16:00:00',   20, 1, 0),
