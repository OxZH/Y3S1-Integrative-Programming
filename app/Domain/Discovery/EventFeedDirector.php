 ...
 * core details, then distance, then rating, then the recommendation signal, then
 * who else is going - so a card and a marker built from the same event can never
 * drift out of sync on what a "complete" item means, only on how much of it a
 * given screen keeps.
 */
final class EventFeedDirector
{
    ...
    public function direct(
        ...
        return $builder
            ...
            ->addFriendSignal($friendsAttending)
            ->build();
    }
}
